// Package service : templates provides support for using HTML
...
func init() {
	...
	// pysically located. Trying to avoid configuration for now.
	pwd, _ := os.Getwd()
	loadTemplate("layouts", pwd+"/views/basic-layout.html")
